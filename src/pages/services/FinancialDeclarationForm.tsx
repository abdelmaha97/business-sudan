...
const formSchema = z.object({
  ...
  registrationNumber: z.string().min(1, "مطلوب"),
  // بيانات الدفع
...
const FinancialDeclarationForm = () => {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto bg-white rounded-lg shadow-lg p-8">
            <div className="flex items-center justify-between mb-8">
              ...
              <h1 className="text-2xl font-bold text-[#003979]">نموذج إقرار الالتزامات المالية الشاملة</h1>
            </div>
...
export default FinancialDeclarationForm;
